    ...
    <div class="row">
        <div class="col-md-6">
            <card>
                ...
                <p class="small" style="margin-bottom: -5px; margin-top: -20px;">This option let's you customize your dashboard by toggling/untoggling widgets from the Dashboard.</p>
                    ...
                    <table style="width:100%; ">
                        <tr style="background-color: #f9f9f9; border-bottom: 3px solid white;">
                            <td style="padding-top: 15px; padding-left: 15px;">
                                <p>Toggle <b>Nodes Online</b> widget </p>
                            </td>
                            <td style="padding-top: 10px;">
                                <toggle-button @change="toggleNodesOnline" :value="this.$store.state.toggleDashboard.showNodesOnline" color="#82C7EB" :sync="true" :labels="true" />
                            </td>
                        </tr>
                        <tr style="background-color: #f9f9f9; border-bottom: 3px solid white;">
                            <td style="padding-top: 15px; padding-left: 15px;">
                                <p>Toggle <b>Transactions</b> widget </p>
                            </td>
                            <td>
                                <toggle-button @change="toggleTransactions" :value="this.$store.state.toggleDashboard.showTransactions" color="#82C7EB" :sync="true" :labels="true" />
                            </td>
                        </tr>
                        <tr style="background-color: #f9f9f9; border-bottom: 3px solid white;">
                            <td style="padding-top: 15px; padding-left: 15px;">
                                <p>Toggle <b>Throughput</b> widget </p>
                            </td>
                            <td>
                                <toggle-button @change="toggleThroughput" :value="this.$store.state.toggleDashboard.showThroughput" color="#82C7EB" :sync="true" :labels="true" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <p class="small" style="margin-bottom: -5px; margin-top: -20px;">This option let's you customize your Wallet Card under Wallet Information with your own label and profile picture.</p>
                <br>
                <form>
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="padding: 0px;">
                                <p-button style="margin-top: -17px; width: 95%; float: right;" @click.native="submitLabel()" type="info">Apply </p-button>
                            </td>
                        </tr>
                    </table>
                </form>
                <table style="width:100%;">
                    <tr>
                        <td style="padding: 0px; width: 81%;">
                            <fg-input type="text" :disabled="true" :placeholder="this.$store.state.walletInfo.imgPath" v-model="this.$store.state.walletInfo.imgPath"></fg-input>
                        </td>
    
    
                        <td style="padding: 0px;">
                            <p-button style="margin-top: -17px; width: 95%; float: right;" @click.native="uploadImage()" type="info">Browse</p-button>
                        </td>
                    </tr>
                </table>
        ...
        <div class="col-md-6">
            <card>
                ...
                <form @submit.prevent>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fg-input type="text" :disabled="true" placeholder="Public Key" v-model="this.$store.state.walletInfo.publicKey">
                            </fg-input>
                        </div>
                    </div>
                    <label class="control-label">
        ...
        uploadImage: function() {
            window.backend.WalletApplication.UploadImage().then(path => {
                if (path === "None") {
                    Swal.fire({
                        title: 'Failed!',
                        text: 'Unable to change wallet image. Make sure that the image resolution is not larger than 200x200',
                        type: 'error'
                    ...
                    Swal.fire({
                            title: "Are you sure?",
                            html: 'You are about to upload ' + path + '. This will replace your existing image.',
                            type: 'warning',
