<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon access-point-check-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AccessPointCheckIcon",
  props: {
    title: {
      type: String,
      default: "Access Point Check icon"
    },
    decorative: {
      type: Boolean,
      default: false
