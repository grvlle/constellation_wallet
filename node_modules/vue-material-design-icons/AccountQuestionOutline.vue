<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon account-question-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AccountQuestionOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Account Question Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
