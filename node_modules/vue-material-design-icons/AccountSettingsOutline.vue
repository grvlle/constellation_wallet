<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon account-settings-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
export default {
  ...
  props: {
    title: {
      type: String,
      default: "Account Settings Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
