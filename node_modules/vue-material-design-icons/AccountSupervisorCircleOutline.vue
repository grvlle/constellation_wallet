<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon account-supervisor-circle-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AccountSupervisorCircleOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Account Supervisor Circle Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
