<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon account-supervisor-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AccountSupervisorOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Account Supervisor Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
