<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon account-tie-voice-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AccountTieVoiceOffIcon",
  props: {
    title: {
      type: String,
      default: "Account Tie Voice Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
