<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon account-tie-voice-off-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AccountTieVoiceOffOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Account Tie Voice Off Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
