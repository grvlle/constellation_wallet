<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon audio-video-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "AudioVideoOffIcon",
  props: {
    title: {
      type: String,
      default: "Audio Video Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
