<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon battery-charging-wireless-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "BatteryChargingWirelessOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Battery Charging Wireless Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
