<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon camcorder-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "CamcorderOffIcon",
  props: {
    title: {
      type: String,
      default: "Camcorder Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
