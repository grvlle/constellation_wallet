<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon camera-metering-matrix-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "CameraMeteringMatrixIcon",
  props: {
    title: {
      type: String,
      default: "Camera Metering Matrix icon"
    },
    decorative: {
      type: Boolean,
      default: false
