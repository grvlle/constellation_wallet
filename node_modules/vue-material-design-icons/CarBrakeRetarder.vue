<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon car-brake-retarder-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "CarBrakeRetarderIcon",
  props: {
    title: {
      type: String,
      default: "Car Brake Retarder icon"
    },
    decorative: {
      type: Boolean,
      default: false
