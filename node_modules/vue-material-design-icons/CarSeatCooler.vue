<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon car-seat-cooler-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "CarSeatCoolerIcon",
  props: {
    title: {
      type: String,
      default: "Car Seat Cooler icon"
    },
    decorative: {
      type: Boolean,
      default: false
