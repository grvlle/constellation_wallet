<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon contactless-payment-circle-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "ContactlessPaymentCircleIcon",
  props: {
    title: {
      type: String,
      default: "Contactless Payment Circle icon"
    },
    decorative: {
      type: Boolean,
      default: false
