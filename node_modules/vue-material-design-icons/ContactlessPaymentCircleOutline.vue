<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon contactless-payment-circle-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "ContactlessPaymentCircleOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Contactless Payment Circle Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
