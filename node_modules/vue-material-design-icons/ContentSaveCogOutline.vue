<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon content-save-cog-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "ContentSaveCogOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Content Save Cog Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
