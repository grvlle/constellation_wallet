<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon credit-card-refresh-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "CreditCardRefreshIcon",
  props: {
    title: {
      type: String,
      default: "Credit Card Refresh icon"
    },
    decorative: {
      type: Boolean,
      default: false
