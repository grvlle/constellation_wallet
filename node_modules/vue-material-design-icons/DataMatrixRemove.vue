<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon data-matrix-remove-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "DataMatrixRemoveIcon",
  props: {
    title: {
      type: String,
      default: "Data Matrix Remove icon"
    },
    decorative: {
      type: Boolean,
      default: false
