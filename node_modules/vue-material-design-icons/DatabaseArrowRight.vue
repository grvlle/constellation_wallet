<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon database-arrow-right-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "DatabaseArrowRightIcon",
  props: {
    title: {
      type: String,
      default: "Database Arrow Right icon"
    },
    decorative: {
      type: Boolean,
      default: false
