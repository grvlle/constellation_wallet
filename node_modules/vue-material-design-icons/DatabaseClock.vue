<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon database-clock-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "DatabaseClockIcon",
  props: {
    title: {
      type: String,
      default: "Database Clock icon"
    },
    decorative: {
      type: Boolean,
      default: false
