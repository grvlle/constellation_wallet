<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon database-off-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "DatabaseOffOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Database Off Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
