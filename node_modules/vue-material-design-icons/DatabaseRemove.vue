<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon database-remove-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "DatabaseRemoveIcon",
  props: {
    title: {
      type: String,
      default: "Database Remove icon"
    },
    decorative: {
      type: Boolean,
      default: false
