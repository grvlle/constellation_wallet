<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon emoticon-poop-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "EmoticonPoopIcon",
  props: {
    title: {
      type: String,
      default: "Emoticon Poop icon"
    },
    decorative: {
      type: Boolean,
      default: false
