<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon ev-plug-chademo-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "EvPlugChademoIcon",
  props: {
    title: {
      type: String,
      default: "Ev Plug Chademo icon"
    },
    decorative: {
      type: Boolean,
      default: false
