<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon ev-plug-tesla-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "EvPlugTeslaIcon",
  props: {
    title: {
      type: String,
      default: "Ev Plug Tesla icon"
    },
    decorative: {
      type: Boolean,
      default: false
