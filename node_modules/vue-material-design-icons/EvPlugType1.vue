<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon ev-plug-type1-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "EvPlugType1Icon",
  props: {
    title: {
      type: String,
      default: "Ev Plug Type1 icon"
    },
    decorative: {
      type: Boolean,
      default: false
