<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon eyedropper-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "EyedropperOffIcon",
  props: {
    title: {
      type: String,
      default: "Eyedropper Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
