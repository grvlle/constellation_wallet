<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon face-shimmer-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "FaceShimmerIcon",
  props: {
    title: {
      type: String,
      default: "Face Shimmer icon"
    },
    decorative: {
      type: Boolean,
      default: false
