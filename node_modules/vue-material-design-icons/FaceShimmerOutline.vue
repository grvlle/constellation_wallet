<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon face-shimmer-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "FaceShimmerOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Face Shimmer Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
