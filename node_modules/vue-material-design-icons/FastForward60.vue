<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon fast-forward60-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "FastForward60Icon",
  props: {
    title: {
      type: String,
      default: "Fast Forward60 icon"
    },
    decorative: {
      type: Boolean,
      default: false
