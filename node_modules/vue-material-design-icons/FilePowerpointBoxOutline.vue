<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon file-powerpoint-box-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "FilePowerpointBoxOutlineIcon",
  props: {
    title: {
      type: String,
      default: "File Powerpoint Box Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
