<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon fruit-citrus-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "FruitCitrusOffIcon",
  props: {
    title: {
      type: String,
      default: "Fruit Citrus Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
