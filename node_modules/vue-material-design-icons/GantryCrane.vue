<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon gantry-crane-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "GantryCraneIcon",
  props: {
    title: {
      type: String,
      default: "Gantry Crane icon"
    },
    decorative: {
      type: Boolean,
      default: false
