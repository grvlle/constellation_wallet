<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon google-street-view-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "GoogleStreetViewIcon",
  props: {
    title: {
      type: String,
      default: "Google Street View icon"
    },
    decorative: {
      type: Boolean,
      default: false
