<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon hand-peace-variant-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HandPeaceVariantIcon",
  props: {
    title: {
      type: String,
      default: "Hand Peace Variant icon"
    },
    decorative: {
      type: Boolean,
      default: false
