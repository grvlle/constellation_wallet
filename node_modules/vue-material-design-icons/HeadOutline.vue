<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon head-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HeadOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Head Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
