<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon heart-off-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HeartOffOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Heart Off Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
