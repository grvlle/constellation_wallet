<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon heart-settings-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HeartSettingsOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Heart Settings Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
