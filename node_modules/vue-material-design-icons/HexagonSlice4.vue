<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon hexagon-slice4-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HexagonSlice4Icon",
  props: {
    title: {
      type: String,
      default: "Hexagon Slice4 icon"
    },
    decorative: {
      type: Boolean,
      default: false
