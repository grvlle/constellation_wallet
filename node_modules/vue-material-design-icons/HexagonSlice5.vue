<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon hexagon-slice5-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HexagonSlice5Icon",
  props: {
    title: {
      type: String,
      default: "Hexagon Slice5 icon"
    },
    decorative: {
      type: Boolean,
      default: false
