<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon hexagon-slice6-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "HexagonSlice6Icon",
  props: {
    title: {
      type: String,
      default: "Hexagon Slice6 icon"
    },
    decorative: {
      type: Boolean,
      default: false
