<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon kettle-steam-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "KettleSteamIcon",
  props: {
    title: {
      type: String,
      default: "Kettle Steam icon"
    },
    decorative: {
      type: Boolean,
      default: false
