<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon language-rust-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "LanguageRustIcon",
  props: {
    title: {
      type: String,
      default: "Language Rust icon"
    },
    decorative: {
      type: Boolean,
      default: false
