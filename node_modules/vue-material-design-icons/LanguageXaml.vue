<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon language-xaml-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "LanguageXamlIcon",
  props: {
    title: {
      type: String,
      default: "Language Xaml icon"
    },
    decorative: {
      type: Boolean,
      default: false
