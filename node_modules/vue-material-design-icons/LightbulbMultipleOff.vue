<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon lightbulb-multiple-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "LightbulbMultipleOffIcon",
  props: {
    title: {
      type: String,
      default: "Lightbulb Multiple Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
