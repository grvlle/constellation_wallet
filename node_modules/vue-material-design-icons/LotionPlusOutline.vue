<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon lotion-plus-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "LotionPlusOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Lotion Plus Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
