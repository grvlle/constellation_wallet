<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-access-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftAccessIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Access icon"
    },
    decorative: {
      type: Boolean,
      default: false
