<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-edge-legacy-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftEdgeLegacyIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Edge Legacy icon"
    },
    decorative: {
      type: Boolean,
      default: false
