<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-sharepoint-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftSharepointIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Sharepoint icon"
    },
    decorative: {
      type: Boolean,
      default: false
