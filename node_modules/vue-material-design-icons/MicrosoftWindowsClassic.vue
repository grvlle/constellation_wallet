<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-windows-classic-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftWindowsClassicIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Windows Classic icon"
    },
    decorative: {
      type: Boolean,
      default: false
