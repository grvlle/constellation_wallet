<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-xbox-controller-battery-alert-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftXboxControllerBatteryAlertIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Xbox Controller Battery Alert icon"
    },
    decorative: {
      type: Boolean,
      default: false
