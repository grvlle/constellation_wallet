<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-xbox-controller-battery-charging-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftXboxControllerBatteryChargingIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Xbox Controller Battery Charging icon"
    },
    decorative: {
      type: Boolean,
      default: false
