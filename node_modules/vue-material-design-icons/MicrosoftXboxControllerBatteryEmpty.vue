<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-xbox-controller-battery-empty-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftXboxControllerBatteryEmptyIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Xbox Controller Battery Empty icon"
    },
    decorative: {
      type: Boolean,
      default: false
