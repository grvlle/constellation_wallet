<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-xbox-controller-battery-medium-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftXboxControllerBatteryMediumIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Xbox Controller Battery Medium icon"
    },
    decorative: {
      type: Boolean,
      default: false
