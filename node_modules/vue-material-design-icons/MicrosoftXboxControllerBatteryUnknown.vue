<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon microsoft-xbox-controller-battery-unknown-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "MicrosoftXboxControllerBatteryUnknownIcon",
  props: {
    title: {
      type: String,
      default: "Microsoft Xbox Controller Battery Unknown icon"
    },
    decorative: {
      type: Boolean,
      default: false
