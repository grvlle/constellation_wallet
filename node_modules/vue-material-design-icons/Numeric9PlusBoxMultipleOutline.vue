<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon numeric9-plus-box-multiple-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "Numeric9PlusBoxMultipleOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Numeric9 Plus Box Multiple Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
