<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon relation-zero-or-one-to-one-or-many-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "RelationZeroOrOneToOneOrManyIcon",
  props: {
    title: {
      type: String,
      default: "Relation Zero Or One To One Or Many icon"
    },
    decorative: {
      type: Boolean,
      default: false
