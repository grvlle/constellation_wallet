<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon rickshaw-electric-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "RickshawElectricIcon",
  props: {
    title: {
      type: String,
      default: "Rickshaw Electric icon"
    },
    decorative: {
      type: Boolean,
      default: false
