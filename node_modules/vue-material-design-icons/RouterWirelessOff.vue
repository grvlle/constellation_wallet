<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon router-wireless-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "RouterWirelessOffIcon",
  props: {
    title: {
      type: String,
      default: "Router Wireless Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
