<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon selection-multiple-marker-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "SelectionMultipleMarkerIcon",
  props: {
    title: {
      type: String,
      default: "Selection Multiple Marker icon"
    },
    decorative: {
      type: Boolean,
      default: false
