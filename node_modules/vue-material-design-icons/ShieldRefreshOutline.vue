<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon shield-refresh-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "ShieldRefreshOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Shield Refresh Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
