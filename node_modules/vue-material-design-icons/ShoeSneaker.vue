<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon shoe-sneaker-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "ShoeSneakerIcon",
  props: {
    title: {
      type: String,
      default: "Shoe Sneaker icon"
    },
    decorative: {
      type: Boolean,
      default: false
