<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon sort-alphabetical-descending-variant-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "SortAlphabeticalDescendingVariantIcon",
  props: {
    title: {
      type: String,
      default: "Sort Alphabetical Descending Variant icon"
    },
    decorative: {
      type: Boolean,
      default: false
