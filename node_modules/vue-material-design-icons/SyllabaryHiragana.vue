<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon syllabary-hiragana-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "SyllabaryHiraganaIcon",
  props: {
    title: {
      type: String,
      default: "Syllabary Hiragana icon"
    },
    decorative: {
      type: Boolean,
      default: false
