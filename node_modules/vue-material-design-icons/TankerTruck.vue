<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon tanker-truck-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "TankerTruckIcon",
  props: {
    title: {
      type: String,
      default: "Tanker Truck icon"
    },
    decorative: {
      type: Boolean,
      default: false
