<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon timeline-remove-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "TimelineRemoveOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Timeline Remove Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
