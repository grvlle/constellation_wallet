<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon transit-connection-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "TransitConnectionIcon",
  props: {
    title: {
      type: String,
      default: "Transit Connection icon"
    },
    decorative: {
      type: Boolean,
      default: false
