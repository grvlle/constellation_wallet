<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon transit-detour-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "TransitDetourIcon",
  props: {
    title: {
      type: String,
      default: "Transit Detour icon"
    },
    decorative: {
      type: Boolean,
      default: false
