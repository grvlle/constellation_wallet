<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon water-boiler-off-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "WaterBoilerOffIcon",
  props: {
    title: {
      type: String,
      default: "Water Boiler Off icon"
    },
    decorative: {
      type: Boolean,
      default: false
